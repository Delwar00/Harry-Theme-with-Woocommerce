...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="woocommerce-mini-cart__total total cartmini__checkout">
		<?php
		/**
	...
	<p class="woocommerce-mini-cart__buttons buttons cartmini__checkout-btn"><?php do_action( 'woocommerce_widget_shopping_cart_buttons' ); ?></p>
